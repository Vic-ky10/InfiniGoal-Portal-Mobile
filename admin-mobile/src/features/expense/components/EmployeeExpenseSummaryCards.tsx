...
interface EmployeeExpenseSummaryCardsProps {
  summary: EmployeeExpenseSummary;
}

export default function EmployeeExpenseSummaryCards({ summary }: EmployeeExpenseSummaryCardsProps) {
  const cards = [
    {
