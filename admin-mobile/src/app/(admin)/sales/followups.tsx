...
export default function AdminFollowupsScreen() {
  ...
  const handleSave = async () => {
    ...
    if (editingFollowup) {
      ...
      // For admin, we can pass a system/profile ID from the session or leave it as createdBy
      createFollowupMutation.mutate(
        { data: payload, createdBy: "admin" },
        {
          onSuccess: (res) => {
            if (res.success) {
  ...
  return (
    <Screen isLoading={loadFollow || loadCust} onRefresh={handleRefresh} refreshing={loadFollow}>
      ...
      <View style={styles.tabContainer}>
        ...
        >
          <AppText weight="700" color={activeTab === "pending" ? adminColors.primary : adminColors.textSecondary}>
        ...
        >
          <AppText weight="700" color={activeTab === "completed" ? adminColors.primary : adminColors.textSecondary}>
