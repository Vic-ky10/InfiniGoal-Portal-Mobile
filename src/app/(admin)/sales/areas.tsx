...
import { useSalesAreas, useDeleteSalesArea } from "@/features/sales/hooks/useSales";
        ...
        <View style={styles.cardHeader}>
          <View style={{ flex: 1 }}>
            ...
            <AppText variant="caption" color={adminColors.textSecondary} style={{ marginTop: 2 }}>
              Code: {item.area_code} • Type: {item.area_type}
            </AppText>
          </View>
          ...
          {!!item.contact_person && (
            <View style={styles.detailRow}>
              ...
              <AppText variant="body" color={adminColors.textSecondary} style={styles.detailText}>
                {item.contact_person} {item.contact_phone ? `(${item.contact_phone})` : ""}
              </AppText>
            </View>
          )}
