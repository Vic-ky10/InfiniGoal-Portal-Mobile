...
interface EmployeeRecentExpenseListProps {
  recentExpenses: Expense[];
}

export default function EmployeeRecentExpenseList({ recentExpenses }: EmployeeRecentExpenseListProps) {
