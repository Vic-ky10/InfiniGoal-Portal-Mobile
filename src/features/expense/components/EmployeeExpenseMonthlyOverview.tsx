...
interface EmployeeExpenseMonthlyOverviewProps {
  monthlySummary: MonthlySummary[];
}

export default function EmployeeExpenseMonthlyOverview({ monthlySummary }: EmployeeExpenseMonthlyOverviewProps) {
  const now = new Date();
  ...
  return (
    <Card style={{ borderWidth: 1, borderColor: adminColors.border, ...shadows.sm, padding: spacing.lg }}>
      ...
      <AppText variant="caption" color={adminColors.textSecondary} style={{ marginTop: 2 }}>
        Comparison of your personal monthly spending
      </AppText>
      ...
      <View style={{ marginTop: spacing.lg, gap: spacing.md }}>
        ...
        <View>
          ...
          <AppText variant="caption" color={adminColors.textSecondary} style={{ marginTop: 4 }}>
            {currentData?.count ?? 0} personal claims submitted
          </AppText>
        </View>
        ...
        <View>
          ...
          <AppText variant="caption" color={adminColors.textSecondary} style={{ marginTop: 4 }}>
            {prevData?.count ?? 0} personal claims submitted
          </AppText>
        </View>
      </View>
